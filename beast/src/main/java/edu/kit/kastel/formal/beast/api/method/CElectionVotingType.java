...
public class CElectionVotingType {
    ...
    private List<BoundVariables> listSizes;
    ...
    public final List<BoundVariables> getListSizes() {
        return listSizes;
    }
    ...
    public final boolean canAccess(final BoundVariables var) {
    ...
    public static final CElectionVotingType of(final VotingOutputType outType) {
        ...
        case CANDIDATE_LIST:
            ...
            created.listSizes = List.of(BoundVariables.AMOUNT_CANDIDATES);
            break;
        case PARLIAMENT:
            created.simpleType = CElectionSimpleType.UNSIGNED_INT;
            created.listDimensions = 1;
    ...
    public static final CElectionVotingType of(final VotingInputType inType) {
        ...
        case APPROVAL:
            ...
            created.listSizes =
                    List.of(BoundVariables.AMOUNT_VOTERS, BoundVariables.AMOUNT_CANDIDATES);
            break;
        case PREFERENCE:
            created.simpleType = CElectionSimpleType.UNSIGNED_INT;
            created.listDimensions = 2;
        ...
        case SINGLE_CHOICE:
            created.simpleType = CElectionSimpleType.UNSIGNED_INT;
            created.listDimensions = 1;
            created.listSizes = List.of(BoundVariables.AMOUNT_VOTERS);
            break;
