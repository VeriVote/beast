...
import edu.kit.kastel.formal.beast.api.os.OS;
import edu.kit.kastel.formal.beast.api.os.OSHelper;
import edu.kit.kastel.formal.beast.api.property.PropertyDescription;
import edu.kit.kastel.formal.beast.gui.ceditor.CEditorCodeElement;
import edu.kit.kastel.formal.beast.gui.ceditor.CElectionEditor;
import edu.kit.kastel.formal.beast.gui.configurationeditor.ConfigurationTopLevelGUIHandler;
import edu.kit.kastel.formal.beast.gui.configurationeditor.treeview.ConfigurationItem;
import edu.kit.kastel.formal.beast.gui.error.ErrorGUIController;
import edu.kit.kastel.formal.beast.gui.error.ErrorHandler;
import edu.kit.kastel.formal.beast.gui.error.ErrorMessageLoader;
import edu.kit.kastel.formal.beast.gui.options.OptionsCategoryGUI;
import edu.kit.kastel.formal.beast.gui.options.OptionsGUIController;
import edu.kit.kastel.formal.beast.gui.options.ceditor.CEditorOptions;
import edu.kit.kastel.formal.beast.gui.options.ceditor.CEditorOptionsGUI;
import edu.kit.kastel.formal.beast.gui.options.processhandler.ProcessHandlerWindowsOptionsGUI;
import edu.kit.kastel.formal.beast.gui.processhandler.CBMCProcessHandlerCreator;
import edu.kit.kastel.formal.beast.gui.propertyeditor.PropertyEditor;
import edu.kit.kastel.formal.beast.gui.propertyeditor.PropertyEditorCodeElement;
...
public class BeastGUIController implements WorkspaceUpdateListener {
    ...
    private static final String OPTIONS_FXML = "/edu/kit/kastel/formal/beast/gui/options.fxml";
