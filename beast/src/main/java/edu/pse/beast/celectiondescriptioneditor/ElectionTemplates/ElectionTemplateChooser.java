    ...
    public ElectionTemplateChooser(NewElectionUserAction action, ElectionTemplateHandler electionTemplateHandler,
        ...
        createButton.addActionListener((ae) -> {
            if (nameField.getText().equals("")) {
                ...
                action.create(inputIds.get(inputList.getSelectedIndex()), resIds.get(resultList.getSelectedIndex()),
                        nameField.getText());
                this.dispose();
            }
        });
        for (ElectionTypeContainer.ElectionInputTypeIds id : electionTemplateHandler.getInputIds()) {
            inputIds.add(id);
            String toAdd = loader.getStringFromID(EnumToIdMapping.getIDInFile(id));
            inputList.addItem(toAdd);
        }

        for (ElectionTypeContainer.ElectionOutputTypeIds id : electionTemplateHandler.getResIds()) {
            resIds.add(id);
