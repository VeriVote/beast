...
public class BooleanExpEditorGrammarErrorFinder implements ANTLRErrorListener {
    ...
    @Override
    public void syntaxError(Recognizer<?, ?> rcgnzr, Object o, int line,
                            int charInline, String msg,
                            RecognitionException re) {
        errors.add(BooleanExpErrorFactory.createAntlrError(line, charInline, msg));
    }

    @Override
    public void reportAmbiguity(Parser parser, DFA dfa, int i, int i1, boolean bln,
