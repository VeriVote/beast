...
//     * @param objectRefs           the ObjectRefsForBuilder instance
//     *                             providing the references to needed
//     *                             loading interfaces
...
//     */
//    public BooleanExpCodeArea
//            createBooleanExpCodeAreaObject(ObjectRefsForBuilder objectRefs,
//                                           JTextPane textPane,
//                                           JScrollPane scrollPane,
//                                           SymbolicVariableList symbolicVariableList,
//                                           CElectionDescriptionEditor ceditor) {
//        BooleanExpErrorDisplayer errorDisplayer =
//            new BooleanExpErrorDisplayer(textPane, objectRefs.getStringIF());
//        CodeArea tempCodeArea =
//            super.createCodeArea(textPane, scrollPane, objectRefs, errorDisplayer);
...
//        created.add(new AutocompletionOption("EXISTS_ONE_CANDIDATE",
...
//        created.add(new AutocompletionOption("<==>", "<==>"));
//        created.add(new AutocompletionOption("VOTE_SUM_FOR_CANDIDATE",
