...
public class CCodeHelper {
     ...
     *
     * @param electionInputTypeIds  the container for which the C type should be
     *                              created
     ...
     *
     * @param electionOutputTypeIds the container for which the C type should be
     *                              created
     * @return the c type
     */
     ...
     *
     * @param input                the input format of the voting array passed to
     *                             the function
     * @param res                  the result format of the voting function
     ...
     * have
     *
     * @param inputType the list whose elements min value needs to be determined
