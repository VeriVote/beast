...
/**
 * class that contains all properties of a project, used to save and load projects
 * @author lukas
 *
 */
public class Project {
	...
	public Project(ElectionDescription electionDescription, List<ParentTreeItem> properties, InputDataDescription inputData) {
