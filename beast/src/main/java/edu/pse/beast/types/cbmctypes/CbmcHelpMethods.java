...
//
// public List<CBMCResultWrapperLong> readLongs(String name, List<String>
// toExtract) {
// List<CBMCResultWrapperLong> toReturn = new
// ArrayList<CBMCResultWrapperLong>();
// Pattern correctChecker = Pattern.compile("(\\b" + name +
// "[0-9]+=[0-9]+u*)(.*)");
...
// List<CBMCResultWrapperSingleArray> list = new
// ArrayList<CBMCResultWrapperSingleArray>();
...
// votesExtractor = Pattern.compile("(\\b" + name +
// "[0-9]+\\[[0-9]+[a-zA-Z]*\\])(=.*)");
...
// int mainIndex =
// Integer.parseInt(newLine.split("=")[0].split(name)[1].split("\\[")[0]);
...
// innerIterator
// .hasNext();) {
// CBMCResultWrapperSingleArray wrapper = (CBMCResultWrapperSingleArray)
// innerIterator.next();
...
// innerIterator
// .hasNext();) {
// CBMCResultWrapperMultiArray wrapper = (CBMCResultWrapperMultiArray)
// innerIterator.next();
// if (wrapper.getMainIndex() == mainIndex) {
...
// List<String> toExtract) {
// List<CBMCResultWrapperMultiArray> list = new
// ArrayList<CBMCResultWrapperMultiArray>();
// Pattern votesExtractor = null;
// Iterator<String> iterator = toExtract.iterator();
// String line = mergeLinesToOne(iterator, SEGMENT_END);
// while (line.length() > 0) {
