...
public class ParliamentStack extends CBMCOutputType {
	...
	public CodeArrayListBeautifier addMarginVerifyCheck(CodeArrayListBeautifier code) {
		...
		code.add("struct stack_result tmp = " + UnifiedNameContainer.getVotingMethod() + "(" + UnifiedNameContainer.getNewVotesName() + "1);");
	...
	public void addVerifyOutput(CodeArrayListBeautifier code) {
		code.add("struct stack_result tmp_result = " + UnifiedNameContainer.getVotingMethod() + "(" + UnifiedNameContainer.getNewVotesName() + "1);");
