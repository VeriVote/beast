...
import edu.pse.beast.gui.configurationeditor.configuration.ConfigurationGUIController;
import edu.pse.beast.gui.configurationeditor.configuration.cbmc.CheckConfigurationGUIController;
import edu.pse.beast.gui.configurationeditor.configuration.cbmc.Configuration;
import edu.pse.beast.gui.configurationeditor.treeview.ConfigurationCategoryItem;
import edu.pse.beast.gui.configurationeditor.treeview.ConfigurationItem;
import edu.pse.beast.gui.configurationeditor.treeview.ConfigurationTreeItem;
import edu.pse.beast.gui.configurationeditor.treeview.PropertyCheckConfigurationItem;
import edu.pse.beast.gui.configurationeditor.treeview.run.RunItem;
import edu.pse.beast.gui.run.RunGUIController;
