...
public class BarCharElement extends ResultImageElement {
	...
	public BarCharElement(double xPosTopLeft, double yPosTopLeft, double xPosBottomRight, double yPosBottomRight,
	...
	private void init() {
		...
		List<Tuple3<String, Double, Color>> remove = new LinkedList<Tuple3<String, Double, Color>>();
	...
	public void drawElement(Graphics2D graphics, double scale) {
		if (totalSize == 0) {
			System.err.println("The bar chart was not given a size larger than zero!");
		} else {
