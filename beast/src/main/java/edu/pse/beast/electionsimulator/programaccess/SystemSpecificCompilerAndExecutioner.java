		...
		if (process != null) {
			...
			if (programProcess != null) {
				...
				outReader = new ThreadedBufferedReader(
						new BufferedReader(new InputStreamReader(programProcess.getInputStream())), result, latch, false);
				errReader = new ThreadedBufferedReader(
						new BufferedReader(new InputStreamReader(programProcess.getErrorStream())), errors, latch, false);
