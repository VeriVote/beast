...
public class JTextPaneToolbox {
     ...
     * In Windows for example, linebreaks are represented by an additional
     * \r before the \n. These won't be returned by this function. This is very usefull
     * since the panes caretposition uses these indices instead of the os-
     * specific ones. Meaning a string such as 0123\r\n|78 would return caret position
     * 5 even though it "should" be position 6.
    ...
    /**
     * calculates the distance to the closest linebreak before pos.
     * If pos is in the first line, it returns pos.
     ...
     * @param line the line number in which the first non-whitespace char should
     * be found
     * @return the absolute positoin of the first non-whitespace character in 
     * line
     */
    ...
    /**
     * finds the absolute position of the beginning of the word in which 
     * the current caret position is:
     * "asd 12|asd asd" returns 3
     * @param pane
     * @return the absolute position of the beginning of the word on
     * which the caret is centered
     */
