...
public final class JTextPaneToolbox {
    ...
    /**
     * Returns the text represented by the JTextPane in a non-OS dependent
     * manner. In Windows for example, line breaks are represented by an
     * additional \r before the \n. These will not be returned by this function.
     * This is very useful since the pane's caret position uses these indices
     * instead of the OS-specific ones. Meaning a string such as 0123\r\n|78
     * would return caret position 5 even though it "should" be position 6.
     *
     * @param pane
     *            the pane who's text should be retrieved
     * @return the text shown by the pane in an OS-independent manner
     */
    public static String getText(final JTextPane pane) {
        try {
            return pane.getStyledDocument().getText(0,
                    pane.getStyledDocument().getLength());
        } catch (BadLocationException ex) {
            Logger.getLogger(JTextPaneToolbox.class.getName())
    ...
    /**
     * Calculates the distance to the closest line break before the given
     * position. If the position is in the first line, it returns position.
     *
     * @param pane
     *            the pane who's text should be considered
     * @param pos
     ...
     *            the pane who's text should be considered
     * @param absPos
     *            the absolute position to be converted into a line number
     ...
     *
     * @param code
     *            The text in which the line number should be found
     * @param absPos
     *            the absolute position to be converted into a line number
     * @return the line number of the line containing absPos
     */
    ...
    /**
     * Finds and returns the absolute position of the beginning of the given
     * line.
     *
     * @param pane
     *            the pane who's code should be searched for the position
     * @param line
     *            the line who's beginning should be found
     ...
     *
     * @param pane
     *            the pane who's code should be searched for the line break
     * @param absPos
     *            the absolute position after which the first line break is to
     *            be found
    ...
    /**
     * Finds all line numbers between an absolute start and end position.
     * example: ("i like\nyou very\nmuch", 0,17) would return 0,1,2
     *
     * @param pane
     *            the pane in who's text the line positions need to be searched
     * @param start
     *            the starting position
     * @param end
    ...
    /**
     * Returns the first character to the left of the caret or "" if there is no
     * such character. position 0: asd|asd returns d
     *
     * @param pane
     *            the pane from who's text the char should be extracted
    ...
    /**
     * Returns the first character to the right of the caret or "" if there is
     * no such character. position 0: asd|asd returns s
     *
     * @param pane
     *            the pane from who's text the char should be extracted
     ...
     *
     * @param pane
     *            the pane in which the character position should be found
     * @param line
     *            the line number in which the first non-whitespace char should
     *            be found
     * @return the absolute position of the first non-whitespace character in
     *         line
     */
    ...
    /**
     * Finds the absolute position of the beginning of the word in which the
     * current caret position is: "asd 12|asd asd" returns 3.
     *
     * @param pane
     *            the text pane
     * @return the absolute position of the beginning of the word on which the
     *         caret is centered
     */
