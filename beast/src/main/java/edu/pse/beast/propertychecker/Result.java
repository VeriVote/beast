...
public abstract class Result implements ResultInterface {
	...
	/**
	 *
	 * @return whether the result is valid (the checking finished normally and was
	 *         not stopped by something else).
	 */
	 ...
	 * 
	 * @param variableMatcher a regex which should match all variable names, e.g
	 *                        "votes1", "votes2", ...
	 * @return a list containing the last values a variable with the following name
	 *         has
	 */
