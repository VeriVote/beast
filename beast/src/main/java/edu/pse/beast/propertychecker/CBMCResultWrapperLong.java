...
public class CBMCResultWrapperLong {
     ...
     * @param mainIndex the index of this variable (for example votes1 has the main index of 1)
     * @param name the name of this variable (for example votes1 has the name votes)
     */
    ...
    /**
     * 
     * @return the index of this variable (for example votes1 has the main index of 1)
     */
