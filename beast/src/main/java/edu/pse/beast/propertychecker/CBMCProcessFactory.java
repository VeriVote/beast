...
public class CBMCProcessFactory extends CheckerFactory {
	 ...
	 * 
	 * @param controller
	 *            the controller that controls this processfactory and that has to
	 *            be reported to, if all the checking for this file has finished
	...
	// break;
	// default:
	// ErrorLogger.log("Warning, your OS couldn't be determined or is not supported
	// yet.");
	// }
	//
	 ...
	 *            the source that describes the election
	 * @param postAndPrepPropDesc
	 *            the property that this specific processfactory should check
