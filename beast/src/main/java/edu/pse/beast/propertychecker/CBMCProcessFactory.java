...
public class CBMCProcessFactory extends CheckerFactory {
	 ...
	 *
	 * @param controller   the controller that controls this processfactory and that
	 *                     has to be reported to, if all the checking for this file
	 *                     has finished
	 * @param electionDesc the source that describes the election
	 * @param result       the result object that the end result should be written
	 *                     to
	...
	protected Checker startProcessCheck(ElectionDescription electionDesc,
		...
		case Windows:
			...
			break;
		case Mac:
			ErrorForUserDisplayer.displayError("MacOS is not supported yet, please implement the "
					+ "class CBMCProcess and add it then here in the " + "CBMCProcessFactory to be created");
			break;
		default:
	...
	protected Checker startProcessMargin(ElectionDescription electionDesc,
		...
		toCheck = createCodeFileMargin(electionDesc, postAndPrepPropDesc, margin, origResult, votingData);
		...
		case Windows:
			...
			break;
		case Mac:
			ErrorForUserDisplayer.displayError("MacOS is not supported yet, please implement the class CBMCProcess "
					+ "and add it then here in the " + "CBMCProcessFactory to be created");
			break;
		default:
			ErrorLogger.log("Warning, your OS could not be determined or is not supported yet.");
		}
