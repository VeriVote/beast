...
public abstract class CheckerFactory implements Runnable {
     ...
     *
     * @param lastResult the last result output from the checker that finished
     * last
     * @param lastError the last error output from the checker that finished
     * last
     */
     ...
     * @param parent the parent that has to be notified when the checker
     * finished
     ...
     * @param postAndPrepPropDesc a description of the given property
