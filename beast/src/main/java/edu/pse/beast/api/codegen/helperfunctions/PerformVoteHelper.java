...
public class PerformVoteHelper {
	...
	private static String template = 
			"ELECT_TYPE GENERATED_VAR = VOTE_FUNC_NAME(VOTE_VAR);\n";
	...
	public static String generateCode(String generatedVarName,
		...
		code = code.replaceAll("ELECT_TYPE", voteResultStruct.getStruct().getName());
		code = code.replaceAll("GENERATED_VAR", generatedVarName);
		code = code.replaceAll("VOTE_FUNC_NAME", options.getVoteFuncName());
