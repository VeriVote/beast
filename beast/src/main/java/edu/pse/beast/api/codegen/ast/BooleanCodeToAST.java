...
import edu.pse.beast.api.codegen.ast.data.Quantifier;
import edu.pse.beast.api.codegen.ast.data.VariableTypeNames;
import edu.pse.beast.api.codegen.ast.expression.BooleanExpListNode;
...
import edu.pse.beast.api.codegen.ast.expression.bool.EquivalenceNode;
...
import edu.pse.beast.api.codegen.ast.expression.bool.ImplicationNode;
import edu.pse.beast.api.codegen.ast.expression.bool.LogicalAndNode;
import edu.pse.beast.api.codegen.ast.expression.bool.LogicalOrNode;
import edu.pse.beast.api.codegen.ast.expression.bool.NotNode;
import edu.pse.beast.api.codegen.ast.expression.bool.QuantifierNode;
...
import edu.pse.beast.api.codegen.ast.expression.type.integer.IntegerValuedExpression;
...
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionBaseListener;
...
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.BinaryRelationExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.BooleanExpListContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.BooleanExpListElementContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.ComparisonExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.ConstantExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.ElectExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.ElectTupleExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.FalseExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.IntegerContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.IntersectElectContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.IntersectVotesContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.IsEmptyExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.NotExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.NumberExpressionContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.PermElectExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.PermVoteExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.QuantifierExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.SymbVarByNameExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.SymbVarByPosExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.SymbolicVarExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.TrueExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.TupleExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.VoteExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.VoteSumExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.VoteSumUniqueExpContext;
import edu.pse.beast.api.property.antlr.FormalPropertyDescriptionParser.VoteTupleExpContext;
