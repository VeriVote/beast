...
// * did not change a String that separated the different parts of the Code before.
// *
...
//        );
//        symVariableList.addSymbolicVariable(
//                "s", new InternalTypeContainer(InternalTypeRep.SEAT)
//        );
//        symVariableList.addSymbolicVariable(
//                "i", new InternalTypeContainer(InternalTypeRep.INTEGER)
//        );
//        initialize();
//        String symbVarComment = "//Symbolic Variables initialization";
...
//                                                    postDescr, symVariableList);
//        instance = new CBMCCodeGenerator(electionDescription,
