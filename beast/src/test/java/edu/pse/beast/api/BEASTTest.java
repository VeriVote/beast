...
import edu.pse.beast.api.testrunner.cbmc.CBMCTestRunnerWindows;
...
class BEASTTest {
	@Test
	void testBEASTSimpleElectionDescriptionSuccess() throws InterruptedException {
	...
	@Test
	void testBEASTSimpleElectionDescriptionFailure() throws InterruptedException {
		InputType it = InputType.getInputTypes().get(2);
		OutputType ot = OutputType.getOutputTypes().get(3);
		ElectionDescription descr = new ElectionDescription("simple", it, ot);
