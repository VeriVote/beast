...
public class MinMaxSpinValueHandlerTest {
    ...
    /**
     * Test of getValues method, of class MinMaxSpinValueHandler with a simple example.
     */
    @Test
    public void testGetValues() {
        System.out.println("getValues");
        MinMaxSpinValueHandler instance = new MinMaxSpinValueHandler(new JSpinner(), new JSpinner());
